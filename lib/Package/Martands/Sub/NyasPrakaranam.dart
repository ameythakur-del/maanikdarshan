...
class NyasPrakaranam extends StatelessWidget {
  const NyasPrakaranam({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    CollectionReference collectionReference = FirebaseFirestore.instance.collection('न्यासप्रकरणम्');

    return Scaffold(
      appBar: ManikDarshan(title: "न्यास प्रकरणम्"),
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListCard(text: data[index], image: 'assets/images/listIcon.png', parent : 'न्यासप्रकरणम्');
                });
          }
