...
class Anivarchya extends StatefulWidget {
  const Anivarchya({Key? key}) : super(key: key);

  @override
  State<Anivarchya> createState() => _AnivarchyaState();
}

class _AnivarchyaState extends State<Anivarchya> {
  ...
  Future<void> getData() async {
    ...
    FirebaseFirestore.instance.collection('Anivarchya');
