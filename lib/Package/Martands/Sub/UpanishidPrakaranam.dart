...
class UpanishidPrakaranam extends StatelessWidget {
  const UpanishidPrakaranam({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    CollectionReference collectionReference = FirebaseFirestore.instance.collection('उपनिषद्');

    return Scaffold(
      appBar: ManikDarshan(title: "उपनिषद् प्रकरणम्"),
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListCard(text: data[index], image: 'assets/images/listIcon.png', parent : 'उपनिषद्');
                });
          }
