...
class SangmeshMahatmya extends StatefulWidget {
  const SangmeshMahatmya({Key? key}) : super(key: key);

  @override
  State<SangmeshMahatmya> createState() => _SangmeshMahatmyaState();
}

class _SangmeshMahatmyaState extends State<SangmeshMahatmya> {
  ...
  Future<void> getData() async {
    ...
    FirebaseFirestore.instance.collection('SangmeshMahatmya');
