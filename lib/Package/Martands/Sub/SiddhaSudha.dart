...
class SiddhaSudha extends StatefulWidget {
  const SiddhaSudha({Key? key}) : super(key: key);

  @override
  State<SiddhaSudha> createState() => _SiddhaSudhaState();
}

class _SiddhaSudhaState extends State<SiddhaSudha> {
  ...
  Future<void> getData() async {
    ...
    FirebaseFirestore.instance.collection('SiddhaSudha');
