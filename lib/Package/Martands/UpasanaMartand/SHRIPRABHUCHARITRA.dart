...
class SHRIPRABHUCHARITRA extends StatefulWidget {
  const SHRIPRABHUCHARITRA({Key? key}) : super(key: key);

  @override
  State<SHRIPRABHUCHARITRA> createState() => _SHRIPRABHUCHARITRAState();
}

class _SHRIPRABHUCHARITRAState extends State<SHRIPRABHUCHARITRA> {
  ...
  Future<void> getData() async {
    ...
    FirebaseFirestore.instance.collection('श्रीप्रभुचरित्र');
