    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          title,
          style:
              TextStyle(fontFamily: 'Mukta-Bold', fontWeight: FontWeight.bold),
        ),
      ...
      Column(children: [
        ...
        Text(text, style: TextStyle(color: const Color(0xFF630F05), fontSize: 14), textAlign: TextAlign.center,)),
